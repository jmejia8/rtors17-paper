...
\abstract*{Physical phenomena have been the inspiration for proposing different
...
\caption{Convergence graphs at the run located in the median of 51 independent %
		runs. Log scale is used for visualization purposes.}
